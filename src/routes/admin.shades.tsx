...
export const Route = createFileRoute("/admin/shades")({
  component: AdminShadesPage,
  head: () => ({ meta: [{ title: "VITA Shades — Admin" }] }),
});
  ...
  return (
    <div className="mx-auto max-w-6xl p-6 md:p-10">
      <header className="mb-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Referensi 16 VITA Classical Shades yang digunakan platform.</p>
      </header>
